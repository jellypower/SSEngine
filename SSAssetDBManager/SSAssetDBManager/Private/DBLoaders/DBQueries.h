...
constexpr utf16 ALL_RANIM_QUERY[] = L"SELECT * from RenderAnims";
...
constexpr utf16 SAVE_RAnim_v_0_QUERY[] =
L"INSERT INTO RenderAnims(AssetName, AssetPath, LastUpdateTime) "
L"VALUES (?, ?, ?) "
