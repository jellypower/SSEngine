#include "DX12GPUShaderAssetInstance.h"
...
DX12GPUShaderAssetInstance::DX12GPUShaderAssetInstance(ShaderAsset* ownerShader)
{
	...
	const wchar_t* AssetPathW = ownerShader->GetAssetPath().C_Str();


	const char* shaderTargetName = nullptr;
	switch (ownerShader->GetShaderType())
	{
	...
	HRESULT hr = D3DCompileFromFile(
		...
		ownerShader->GetEntryPointName().C_Str(),
		shaderTargetName,
		compileFlags,
		0,
		&_compiledShader,
...
DX12GPUShaderAssetInstance::~DX12GPUShaderAssetInstance()
{
...
bool DX12GPUShaderAssetInstance::IsValid() const
{
	return _compiledShader != nullptr;
}
